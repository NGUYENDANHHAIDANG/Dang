...
namespace WaterBill
{
    ...
    const double VAT = 0.10;
        ...
        private int thisMonthReading;

        public Customer(string customerName, string? customerType, int lastMonthReading, int thisMonthReading)
        {
        ...
        internal object getWaterConsumption()
        {
